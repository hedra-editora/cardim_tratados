...
\section{Dos animais}
\index{Veado}\paragraph{Veado} Na língua brasílica se chama \textit{Sugoaçu};\footnote{ O veado 
...
\index{Tapyretê}\paragraph{Tapyretê\footnote{ \textit{Tapyretê} é a anta
...
\index{Porco montês}\paragraph{Porco montês} Há grande cópia de porcos monteses, e é o
...
\index{Acuti}\paragraph{Acuti} ou \textit{Cutia}\footnote{ \textit{Acuti} ou
...
\index{Paca}\paragraph{Paca\footnote{ \textit{Paca} é um mamífero
...
\index{Iagoaretê}\paragraph{Iagoaretê\footnote{ \textit{Iagoaretê, Jaguareté} ou
...
\index{Sarigué}\paragraph{Sarigué\footnote{ \textit{Sarigué, sariguê, sarué,
...
\index{Tamanduá}\paragraph{Tamanduá\footnote{ \textit{Tamanduá} é a designação
...
\index{Tatu}\paragraph{Tatu\footnote{ \textit{Tatu} é o nome genérico dos
...
\index{Canduaçu}\paragraph{Canduaçu\footnote{ \textit{Canduaçu, Coandu} ou
...
\index{Eirara}\paragraph{Eirara\footnote{ \textit{Eirara, irara} ou
...
\index{Aquigquig}\paragraph{Aquigquig\footnote{ \textit{Aquigquig}: não há
...
\index{Coati}\paragraph{Coati\footnote{ \textit{Coati} ou \textit{cuati} é
...
\index{Gatos"-bravos}\paragraph{Gatos"-bravos\footnote{ \textit{Gatos bravos} ou
...
\index{Iaguaruçu}\paragraph{Iaguaruçu\footnote{ \textit{Iaguaruçu, joquara"-guaçu} ou 
...
\index{Tapiti}\paragraph{Tapiti\footnote{ \textit{Tapiti}, mamífero lagomorfo
...
\index{Iaguacini}\paragraph{Iaguacini\footnote{ \textit{Iaguacini} ou
...
\index{Biarataca}\paragraph{Biarataca\footnote{ \textit{Biarataca, jaritataca,
...
\index{Preguiça}\paragraph{Preguiça\footnote{ \textit{Preguiça} é a designação
...
\index{Ratos}\paragraph{Ratos\footnote{ Cardim refere"-se aos ratos de espécie
...
\section[Das cobras que andam na terra e não têm peçonha]{Das cobras que andam na\break terra e não têm peçonha}
\index{Gibóia}\paragraph{Gibóia\footnote{ \textit{Gibóia}, \textit{jiboya} ou 
...
\index{Jararaca}\paragraph{Jararaca\footnote{ \textit{Jararaca} é uma das cobras
...
\index{Surucucu}\paragraph{Surucucu\footnote{ \textit{Surucucu}: cobra da mesma
...
\index{Boicininga}\paragraph{Boicininga\footnote{ \textit{Boicininga}: usualmente
...
\index{Igbigracuâ}\paragraph{Igbigracuâ\footnote{ \textit{Igbigracuâ}: de difícil
...
\index{Igbigboboca}\paragraph{Igbigboboca\footnote{ \textit{Igbigboboca, ibiboboca} ou
...
\index{Papagaios}\paragraph{Papagaios\footnote{ Os papagaios são diversas espécies de
...
\index{Arara}\paragraph{Arara\footnote{ \textit{Arara} é o nome comum aos
...
\index{Anapúru}\paragraph{Anapúru\footnote{ \textit{Anapúru} é uma espécie de
...
\index{Ajurucurao}\paragraph{Ajurucurao\footnote{ \textit{Ajurucurao, ajuru"-carau} é
...
\index{Tuin}\paragraph{Tuin\footnote{ \textit{Tuin, tuim, tuî} é o nome genérico
...
\index{Guigrajuba}\paragraph{Guigrajuba\footnote{ \textit{Guigrajuba, guirajuba,
...
\index{Iapu}\paragraph{Iapu\footnote{ \textit{Iapu, japu} é o nome comum a
...
\index{Guainumbig}\paragraph{Guainumbig\footnote{ \textit{Guainumbig, Guainumbi,
...
\index{Guigranheengetá}\paragraph{Guigranheengetá\footnote{ \textit{Guigranheegetá,
...
\index{Tangará}\paragraph{Tangará\footnote{ \textit{Tangará} é o nome comum a
...
\index{Quereiuá}\paragraph{Quereiuá\footnote{ \textit{Quereiuá} \textit{quiruá} ou
...
\index{Tucana}\paragraph{Tucana\footnote{ \textit{Tucana}: vulgarmente denominado de
...
\index{Guigraponga}\paragraph{Guigraponga\footnote{ \textit{Guigraponga} ou
...
\index{Macucaguá}\paragraph{Macucaguá\footnote{ \textit{Macucaguá}, \textit{macaguá,
...
\index{Mutu}\paragraph{Mutu\footnote{ \textit{Mutu} ou \textit{mutum} é o nome
...
\index{Uru}\paragraph{Uru\footnote{ \textit{Uru} é o nome comum a duas espécies
...
\index{Nhandugoaçu}\paragraph{Nhandugoaçu\footnote{ \textit{Nhandugoaçu}: tal como Cardim
...
\index{Anhigma}\paragraph{Anhigma\footnote{ \textit{Anhigma, anhuma} ou \textit{inhuma}
...
\index{Acaju}\paragraph{Acaju\footnote{ \textit{Acaju} ou \textit{caju} é
...
\index{Mangaba}\paragraph{Mangaba\footnote{ \textit{Mangaba} é o fruto e árvore, a
...
\index{Macuoé}\paragraph{Macuoé\footnote{ \textit{Macuoé, mucuoé, mucugê}, 
...
\index{Araçá}\paragraph{Araçá\footnote{ \textit{Araçá} é o nome atribuído às
...
\index{Ombu}\paragraph{Ombu\footnote{ \textit{Ombu, umbu, imbu} ou \textit{ambu} é
...
\index{Jaçapucaya}\paragraph{Jaçapucaya\footnote{ \textit{Jaçapucaya} ou \textit{sapucaia} 
...
\index{Araticu}\paragraph{Araticu\footnote{ \textit{Araticu} ou \textit{ariticum} é o
...
\index{Pequeá}\paragraph{Pequeá\footnote{ \textit{Pequeá, pequiá ou piquiá}: da
...
\index{Jaboticaba}\paragraph{Jaboticaba\footnote{ \textit{Jaboticaba} ou
...
\index{Pinheiro}\paragraph{Pinheiro\footnote{ Cardim menciona o \textit{Pinheiro} ou
...
\section{Das árvores que servem para mezinhas}
\index{Cabureigba}\paragraph{Cabureigba\footnote{ \textit{Cabureigba, caburahida,
...
\index{Cupaigba}\paragraph{Cupaigba\footnote{ \textit{Cupaigba} ou \textit{copahiba}: 
...
\index{Ambaigba}\paragraph{Ambaigba\footnote{ \textit{Ambaigba, ambahiba, embaúba} ou
...
\index{Ambaigtinga}\paragraph{Ambaigtinga\footnote{ \textit{Ambaigtinga} ou
...
\index{Igbacamuci}\paragraph{Igbacamuci\footnote{ \textit{Igbacamuci}: não encontramos
...
\index{Igcigca}\paragraph{Igcigca\footnote{ \textit{Igcigca, icica} ou
...
\index{Curupicaigba}\paragraph{Curupicaigba\footnote{ \textit{Curupicaigba} ou
...
\index{Caaroba}\paragraph{Caaroba\footnote{ \textit{Caaroba} ou \textit{caroba} é
...
\index{Caarobmoçorandigba}\paragraph{Caarobmoçorandigba\footnote{ \textit{Caarobmoçorandigba,
...
\index{Iabigrandi}\paragraph{Iabigrandi\footnote{ \textit{Iabigrandi} ou \textit{jaburandi}
...
\index{Andá}\paragraph{Andá\footnote{ \textit{Andá} ou \textit{andá"-açu}, 
...
\index{Moxerecuigba}\paragraph{Moxerecuigba\footnote{ \textit{Moxerecuigba} ou
...
\index{Aiuruatubira}\paragraph{Aiuruatubira\footnote{ \textit{Airuatubira} ou
...
\index{Aiabutipigta}\paragraph{Aiabutipigta\footnote{ \textit{Aiabutipigta}, 
...
\index{Ianipaba}\paragraph{Ianipaba\footnote{ \textit{Ianipaba}, \textit{genipapo} ou
...
\index{Iequigtiygoaçu}\paragraph{Iequigtiygoaçu\footnote{ \textit{Iequigtygoaçu}: segundo o
...
\section{Das árvores que servem para madeira}
...
\section{Das ervas que são fruto e se comem}
\index{Mandioca}\paragraph{Mandioca\footnote{ \textit{Mandioca} é da família das
...
\index{Naná}\paragraph{Naná\footnote{ \textit{Naná} ou \textit{ananás}, 
...
\index{Pacoba}\paragraph{Pacoba\footnote{ \textit{Pacoba} ou \textit{pacova} é o
...
\index{Maracujá}\paragraph{Maracujá\footnote{ \textit{Maracujá} ou \textit{murucujá} 
...
\index{Tetigcucu}\paragraph{Tetigcucu\footnote{ \textit{Tetigcucu, ietigcucu} ou
...
\index{Igpecacóaya}\paragraph{Igpecacóaya\footnote{ \textit{Igpecacóaya} ou \textit{
...
\index{Cayapiá}\paragraph{Cayapiá\footnote{ \textit{Cayapa, caapiá} ou \textit{capiá},
...
\index{Tareroquig}\paragraph{Tareroquig\footnote{ \textit{Tareroquig} ou \textit{tareroqui}: 
...
\index{Goembegoaçu}\paragraph{Goembegoaçu\footnote{ \textit{Goembegoaçu, guembé"-guaçu} ou
...
\index{Caáobetinga}\paragraph{Caáobetinga\footnote{ \textit{Caáobetinga}: planta difícil
...
\index{Sobaúra}\paragraph{Sobaúra\footnote{ \textit{Sobaúra}: planta difícil de
...
\index{Erva santa}\paragraph{Erva santa\footnote{ \textit{Erva"-santa, fumo, tabaco,
...
\index{Guaraquigynha}\paragraph{Guaraquigynha\footnote{ \textit{Guaraquigynha, guaraquim,
...
\index{Camará}\paragraph{Camará\footnote{ \textit{Camará} ou \textit{cambará}, da
...
\index{Aipo}\paragraph{Aipo\footnote{ \textit{Aipo}, da família das Umbeliferáceas
...
\index{Malvaísco}\paragraph{Malvaísco\footnote{ \textit{Malvaísco}: da família das
...
\index{Caraguatá}\paragraph{Caraguatá\footnote{ \textit{Caraguatá, carauqatá, carautá,
...
\index{Timbó}\paragraph{Timbó\footnote{ \textit{Timbó}, designação comum a várias
...
\index{Erva que dorme}\paragraph{Erva que dorme\footnote{ \textit{Erva que dorme, dormideira}
...
\index{Erva viva}\paragraph{Erva viva\footnote{ \textit{Erva"-viva, sensitiva,
...
\section{Dos peixes que há na água salgada}
\index{Peixe boi}\paragraph{Peixe boi\footnote{ \textit{Peixe boi} é um cetáceo da
...
\index{Bigjuipirá}\paragraph{Bigjuipirá\footnote{ \textit{Bigjupirá, bijupirá} ou
...
\index{Olho de boi}\paragraph{Olho de boi\footnote{ \textit{Olho"-de"-boi}, peixe de água
...
\index{Camurupig}\paragraph{Camurupig\footnote{ \textit{Camuripig, camurupi} ou
...
\index{Peixe selvagem}\paragraph{Peixe selvagem\footnote{ \textit{Peixe selvagem}, da família
...
\index{Balêa}\paragraph{Balêa\footnote{ \textit{Baleia} é o nome comum aos grandes
...
\index{Espadarte}\paragraph{Espadarte\footnote{ \textit{Espadarte}, peixe da família dos
...
\index{Tartaruga}\paragraph{Tartaruga\footnote{ \textit{Tartaruga} é o nome comum aos
...
\index{Tubarões}\paragraph{Tubarões\footnote{ \textit{Tubarões} existem várias
...
\index{Peixe voador}\paragraph{Peixe voador\footnote{ \textit{Peixe voador}, da família dos
...
\index{Botos}\paragraph{Botos} e \textit{Tuninhas}\footnote{ \textit{Botos} e 
...
\index{Linguados}\paragraph{Linguados\footnote{ \textit{Linguado} é um teleósteo,
...
\section{Dos peixes peçonhentos}
...
\index{Peixe sapo}\paragraph{Peixe sapo,} pela língua \textit{Guamayaçu}\footnote{ \textit{Peixe sapo}, 
...
\index{Purá}\paragraph{Purá\footnote{ \textit{Purá, puraquê} ou
...
\index{Caramuru}\paragraph{Caramuru\footnote{ \textit{Caramuru} ou \textit{moreia} é a
...
\index{Amoreati}\paragraph{Amoreati\footnote{ \textit{Amoreati} ou \textit{moreiatim} 
...
\index{Guamaiacucurub}\paragraph{Guamaiacucurub\footnote{ \textit{Guamaiacucurub} ou
...
\index{Terepomonga}\paragraph{Terepomonga\footnote{ \textit{Terepomonga}: pela descrição
...
\index{Polvos}\paragraph{Polvos\footnote{ \textit{Polvo}: molusco
...
\index{Azula}\paragraph{Azula\footnote{ \textit{Azula} ou \textit{apula} é um
...
\index{Águas mortas}\paragraph{Águas mortas\footnote{ \textit{Águas mortas}, hoje
...
\index{Uçá}\paragraph{Uçá\footnote{ \textit{Uçá} é um caranguejo,
...
\index{Guanhumig}\paragraph{Guanhumig\footnote{ \textit{Guanhumig, guayamú} ou
...
\index{Aratú}\paragraph{Aratú\footnote{ \textit{Aratú}: esta variedade de caranguejo
...
\index{Ostras}\paragraph{Ostras\footnote{ \textit{Ostras}, moluscos bivalves,
...
\index{Mexilhões}\paragraph{Mexilhões\footnote{ \textit{Mexilhões} são os moluscos
...
\index{Berbigões}\paragraph{Berbigões\footnote{ \textit{Berbigões} são os moluscos
...
\index{Búzios}\paragraph{Búzios\footnote{ \textit{Búzios} são também moluscos
...
\index{Piriguay}\paragraph{Piriguay\footnote{ \textit{Piraguay, perigoari} ou
...
\index{Coral branco}\paragraph{Coral branco\footnote{ \textit{Coral branco}: trata"-se de
...
\index{Lagostins}\paragraph{Lagostins\footnote{ \textit{Lagostins} é o nome comum a
...
\section{Das árvores que se criam na água salgada}
\index{Mangues}\paragraph{Mangues\footnote{ \textit{Mangue} é a designação
...
\index{Guigratinga}\paragraph{Guigratinga\footnote{ \textit{Guigratinga,
...
\index{Caripirá}\paragraph{Caripirá\footnote{ \textit{Cariripirá} ou \textit{grapirá}, 
...
\index{Guacá}\paragraph{Guacá\footnote{ \textit{Guacá} é a \textit{gaivota} de
...
\index{Guigratéotéo}\paragraph{Guigratéotéo\footnote{ \textit{Guigratéotéo, téu"-téu}, ave
...
\index{Calcamar}\paragraph{Calcamar\footnote{ \textit{Calcamar}, também denominadas de
...
\index{Ayaya}\paragraph{Ayaya\footnote{ \textit{Ayaya, ajajá} ou \textit{colhereiro}
...
\index{Saracura}\paragraph{Saracura\footnote{ \textit{Saracura}, nome comum a diversas
...
\index{Guará}\paragraph{Guará\footnote{ \textit{Guará} é uma ave ciconiforme, da
...
\section{Dos rios de água doce, e cousas que neles há}
...
\section{Das cobras de água doce}
\index{Sucurijuba}\paragraph{Sucurijuba\footnote{ \textit{Sucurijuba, sucuriju}
...
\index{Manima}\paragraph{Manima\footnote{ \textit{Manima}: o termo tupi parece
...
\section{Dos lagartos de água}
\index{Jacaré}\paragraph{Jacaré\footnote{ \textit{Jacaré} é a denominação
...
\section[Dos lobos de água]{Dos lobos de água\protect\footnote[*]{ \MakeUppercase{O P}e. \MakeUppercase{F}ernão \MakeUppercase{C}ardim aborda
...
\index{Jaguaruçu}\paragraph{Jaguaruçu\footnote{ \textit{Jaguaruçu}: este animal
...
\index{Atacape}\paragraph{Atacape\footnote{ \textit{Atacape} é outro animal de
...
\index{Pagnapopeba}\paragraph{Pagnapopeba\footnote{ \textit{Pagnapopeba, jaguapopeba} ou
...
\index{Baéapina}\paragraph{Baéapina\footnote{ \textit{Baéapina}: monstro marinho, cujo
...
\index{Capijuara}\paragraph{Capijuara\footnote{ \textit{Capijuara, capibara} ou
...
\index{Itã}\paragraph{Itã\footnote{ \textit{Itã} ou \textit{itan} são conchas
...
\index{Cágados}\paragraph{Cágados\footnote{ \textit{Cágados} é a designação comum a
...
\index{Guararigeig}\paragraph{Guararigeig\footnote{ \textit{Guararigeig} ou
...
\section[Dos animais, árvores, ervas, que vieram de Portugal]{Dos animais, árvores, ervas, que vieram\break de Portugal e se dão no Brasil}
...
\index{Cavalos}\paragraph{Cavalos} Nesta província se dá bem a criação de cavalos e há
...
\index{Vacas}\paragraph{Vacas} Ainda que esta terra tem os pastos fracos; e em Porto
...
\index{Porcos}\paragraph{Porcos} Os porcos se dão cá bem, e começa de haver grande
abundância; é cá a melhor carne de todas, ainda que de galinha, e se dá
aos doentes, e é muito bom gosto.

\index{Ovelhas}\paragraph{Ovelhas} Até o Rio de Janeiro se acham já muitas ovelhas, e
carneiros, e engordam tanto que muitos arrebentam de gordos, nem é cá
tão boa carne como em Portugal.

\index{Cabras}\paragraph{Cabras} As cabras ainda são poucas, porém dão"-se bem na
terra, e vão multiplicando muito, e cedo haverá grande multidão.

\index{Galinhas}\paragraph{Galinhas} As galinhas são infinitas, e maiores que no Reino,
...
\index{Perus}\paragraph{Perus\footnote{ \textit{Peru} é uma ave galiforme selvagem,
...
\index{Adens}\paragraph{Adens\footnote{ \textit{Adens} é o ganso, uma ave
...
\index{Cães}\paragraph{Cães} Os cães têm multiplicado muito nesta terra, e há"-os de
...
\index{Árvores}\paragraph{Árvores} As árvores de espinhos, como laranjeiras, cidreiras,
...
\index{Figueiras}\paragraph{Figueiras} As figueiras se dão cá bem, e há muitas castas,
...
\index{Marmeleiros}\paragraph{Marmeleiros} No Rio de Janeiro, e São Vicente, e no campo de
...
\index{Parreiras}\paragraph{Parreiras} Há muitas castas de uvas como ferrais, boais,
...
\index{Ervas}\paragraph{Ervas} No Rio de Janeiro e Piratininga há muitas roseiras,
...
\index{Legumes}\paragraph{Legumes} Melões não faltam em muitas capitanias, e são bons e
...
\index{Trigo}\paragraph{Trigo} No Rio de Janeiro e Campo de Piratininga se dá bem
...
\index{Ervas cheirosas}\paragraph{Ervas cheirosas} Há muitos magiricões, cravos amarelos, e
...
\section{Do conhecimento que têm do Criador}
...
\section{Do modo que têm em seus comer e beber}
...
\section{Do modo que têm em dormir} 
...
\section[Da criação dos filhos]{Da criação dos filhos\protect\footnote[*]{ \MakeUppercase{T}ema que interessou muito o
...
\section[Do costume que têm em agasalhar os hóspedes]{Do costume que têm em\break 
...
\section{Do costume que têm em beber fumo} 
...
\section{Dos seus bailos e cantos} 
...
\section{Das ferramentas de que usam} 
...
\section[Do modo que este gentio tem acerca de matar e comer]{Do modo que este gentio tem acerca\break de matar e comer carne humana} 
...
\section[Da diversidade de nações e línguas \medskip]{Da diversidade de nações e línguas\protect\footnote[*]{ \MakeUppercase{O}
